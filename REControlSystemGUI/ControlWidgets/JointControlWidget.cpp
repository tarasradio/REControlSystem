...
//void JointControlWidget::setModel(MotorTableModel *model)
//{
//    mModel = model;
//}

//void JointControlWidget::RowChanged(int cRow)
//{
//    state = States::STOPBRAKE;
...
void JointControlWidget::UpdateData()
{
...
void JointControlWidget::on_ButtonSTOP_clicked()
{
    //mWriteBuffer->motorStopBrake(CurrentNumber);
    ui->checkBoxTrace->setChecked(false);
...
void JointControlWidget::on_ButtonBRAKE_clicked()
{
...
void JointControlWidget::on_ButtonRELAX_clicked()
{
...
void JointControlWidget::on_groupBoxCalibration_clicked(bool checked)
{
    if(!checked)
    {
...
void JointControlWidget::on_ButtonSaveZero_clicked()
{
...
void JointControlWidget::on_SliderAngle_sliderMoved(int position)
{
    if(state == States::TRACE)
    {
...
void JointControlWidget::on_checkBoxTrace_clicked(bool checked)
{
...
void JointControlWidget::SliderInit()
{
...
void JointControlWidget::initWidgets()
{
...
void JointControlWidget::updateInfo()
{
